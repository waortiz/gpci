...
sessionStorage:localStorage).getItem("DataTables_"+a.sInstance+"_"+location.pathname))}catch(b){}},fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": Ordenar columna de forma ascendente",
sSortDescending:": Ordenar columna de forma descendente"},oPaginate:{sFirst:"Primero",sLast:"Anterior",sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No se han encontrado registros",sInfo:"Encontrados _START_ a _END_ de _TOTAL_ registros",sInfoEmpty:"Vista 0 a 0 de 0 registros",sInfoFiltered:"(Filtro para un total de _MAX_  registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Ver _MENU_ registros",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se han encontrado registos"},
